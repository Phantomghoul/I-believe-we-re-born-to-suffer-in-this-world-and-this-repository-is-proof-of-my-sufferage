...
Observations
when we perform an operation on an element, the element will be less than 10.
When the operation is performed, the first digit must be less than a[i+1]
the last digit must be less than a[i-1]


    What stressed me the most 
    - Understanding complex test-cases such as 
-> a = {12,69,30} 
-> {1,2,6,9,30}


  How I managed it
  - I looked at editorials
  - I saw how others did it
  - I tried to understand and did it myself without looking at the code
  - surprisingly took a break from coding and solved it faster :)
*/
/*
